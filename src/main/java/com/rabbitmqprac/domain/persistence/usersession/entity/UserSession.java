...
public class UserSession implements Serializable {
    ...
    private UserSession(
        ...
        validate(userId, status, lastActiveAt);
    ...
    public static UserSession of(Long userId) {
        return new UserSession(userId, UserStatus.ACTIVE_APP, -1L, LocalDateTime.now());
    }
    ...
    public boolean equals(Object o) {
        ...
        return userId.equals(that.userId)
                && currentChatRoomId.equals(currentChatRoomId)
    ...
    private void validate(Long userId, UserStatus status, LocalDateTime lastActiveAt) {
        if (userId == null) {
